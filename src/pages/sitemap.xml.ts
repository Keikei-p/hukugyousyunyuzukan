...
export function GET() {
const paths = ['/', '/guide/', '/beginner-side-job/', '/home-side-job/', '/smartphone-side-job/', '/safe-side-job/', '/side-income-10000/', '/ai-side-job/', '/affiliate/', '/ad-income/', '/about/', '/editorial/', '/privacy/', '/contact/', ...jobs.map(job => '/jobs/' + job.slug + '/')];
